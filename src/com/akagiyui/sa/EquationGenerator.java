...
public class EquationGenerator implements Iterator<Equation>, Iterable<Equation>  {
    ...
    private Equation generateEquation(Range range) {
        ...
        if (random.nextBoolean()) {
            ...
            addEquationBuilder.setOperand1(operand1);
            addEquationBuilder.setOperand2(operand2);
            return addEquationBuilder.buildAddEquation();
        } else {
            ...
            return subEquationBuilder.buildSubEquation();
        }
    }
