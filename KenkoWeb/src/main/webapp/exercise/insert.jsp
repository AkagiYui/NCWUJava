...
<html>
  ...
  <body>
    ...
    <p>
      ...
      在这里其实就相当于上个实验设计的<b>注册页面</b>，这里不再编写冗余代码。<br>
      如果希望参考上个实验的代码，可以<a href="register.jsp"><b>点击这里</b></a>跳转到上个实验的页面。
    </p>
    <iframe src="register.jsp" width="100%" height="400px"></iframe>
  </body>
